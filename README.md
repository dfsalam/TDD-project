...
**[TDD Project]** which stands for Test-Driven Development is a project which tests the ability to write classes and methods after creating the tests for the intended behaviour
...
<details>
<summary>TDD Project built with Ruby</summary>
  <ul>
...
- git clone https://github.com/dfsalam/TDD-project
- cd TDD-project
...
Feel free to check the [issues page](https://github.com/dfsalam/TDD-project/issues).
...
This project is [MIT](https://github.com/dfsalam/TDD-project/blob/dev/LICENSE) licensed.
